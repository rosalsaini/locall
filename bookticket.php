...
<br>
<form name="ticket" action="showticket.php" method="get">
...
<br>
<button onclick="showticket.php" class="w3-padding-xlarge w3-teal w3-button w3-ripple w3-hover-black" style="width:50%; border:2px solid w3-black">Book Ticket</button>
